...
async function loadCandidates() {
  ...
  candidates.forEach((c) => {
    ...
    //   </label>
    //   <div>
    //     Reg <input type="number" class="reg_hours" step="0.5">
    //     OT <input type="number" class="ot_hours" step="0.5">
    //     Holiday <input type="number" class="holiday_hours" step="0.5">
    //   </div>
    // `;
    candidateList.innerHTML = `
  <table>
...
//   const a = document.createElement("a");
//   a.href = url;
//   a.download = ""; // filename comes from backend
//   document.body.appendChild(a);
//   a.click();
//   a.remove();
